...
def extract_skill_icons():
    """Extract all skill icon URLs from the Vex page"""
    url = "https://borderlands.2k.com/borderlands-4/game-info/vault-hunters/vex/"
    ...
    try:
        ...
        for img in images:
            ...
            if 'BL4_Vex_Tree' in src and ('PASSIVE' in src or 'ACTIVE' in src or 'AUGMENT' in src or 'CAPSTONE' in src):
                # Clean up the URL
                if src.startswith('//'):
                    src = 'https:' + src
                ...
                skill_tree = 'unknown'
                if 'The_Fourth_Seal' in src or 'fourth_Seal' in src or 'Fourth_Seale' in src:
                    skill_tree = 'the_fourth_seal'
                elif 'Vexcalation' in src:
                    skill_tree = 'vexcalation'
                elif 'Here_Comes_Trouble' in src:
                    skill_tree = 'here_comes_trouble'
...
def main():
    ...
    print("Extracting Vex skill icon URLs...")
    ...
    # Print summary
    print("\nSummary:")
    for tree in ['the_fourth_seal', 'vexcalation', 'here_comes_trouble']:
